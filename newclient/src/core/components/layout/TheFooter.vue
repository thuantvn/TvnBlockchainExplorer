<template>
    <v-footer height="auto" color="white">
                    ...
                    <v-layout row wrap justify-start align-center fill-height>
                        ...
                        <v-flex xs12>
                            <v-layout row justify-start align-center fill-height pa-1>
                                <v-btn href="https://www.reddit.com/" icon class="ma-1">
                                    <v-icon small class="fab fa-reddit grey--text"></v-icon>
                                </v-btn>
                                <v-btn href="https://twitter.com/" icon class="ma-1"> <v-icon small class="fab fa-twitter grey--text"></v-icon> </v-btn>
                                <v-btn href="https://github.com/" icon class="ma-1"> <v-icon small class="fab fa-github grey--text"></v-icon> </v-btn>
                                <v-btn href="https://medium.com/" icon class="ma-1">
      ...
      =====================================================================================
      -->
            <v-flex :class="flexClass" xs12 sm6 md order-xs5>
