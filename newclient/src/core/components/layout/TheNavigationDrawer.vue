    ...
    <div id="nav">
            ...
            <v-layout column fill-height>
                <v-flex>
                    ...
                    <v-layout v-if="mini" column>
                        <v-img :src="require('@/assets/logo-new.png')" height="70px" max-width="80px" contain class="mb-2 mt-2"></v-img>
                    </v-layout>
                    <v-layout v-else align-end justify-start row>
                        <v-img :src="require('@/assets/logo-new.png')" height="50px" max-width="130px" contain class="mb-4 mt-4 ml-2"></v-img>
                    </v-layout>
        ...
        <v-toolbar :color="headerColor" :fixed="!showMobile" :scroll-threshold="200" :extended="showSearchMobile" app clipped flat>
            ...
            <v-layout v-if="showMobile" align-center row fill-height>
                <v-flex shrink>
                    <v-layout align-end justify-start row fill-height>
                        <v-img :src="require('@/assets/logo-new.png')" height="30px" width="70px" contain></v-img>
                    </v-layout>
                </v-flex>
                <v-spacer />
                <v-flex xs1> <network :select-items="selectItems" /> </v-flex>
            ...
            <v-layout v-else align-center row fill-height>
                ...
                <v-spacer />
                <v-flex xs9 sm7 md1> <network :select-items="selectItems" /> </v-flex>
...
import Network from '@app/modules/network/Network.vue'
...
export default class TheNavigationDrawer extends Vue {
  ...
  */
    ...
    supportEmail = 'support@thangovn.com'
    drawer: boolean = false
    active = 0
    sublink = null
    mini: boolean = false
    showSearchMobile: boolean = false
    selectItems = networksData
