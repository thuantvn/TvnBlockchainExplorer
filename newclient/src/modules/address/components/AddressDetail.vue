                ...
                <v-layout :class="layoutPadding" row wrap justify-space-between>
                    ...
                    <v-flex xs12 md6>
                        <v-card class="primary white--text pl-2 pr-2 desktop-block" flat>
                            <v-card-text class="pb-0">{{ isTrx ? $t('common.trx-balance') : $t('common.eth-balance') }}</v-card-text>
                            <v-card-title v-if="!loading" class="title font-weight-regular text-truncate pr-1"
                                >{{ balance.value }} {{ isTrx ? $t('common.trx') : $t(`common.${balance.unit}`) }}
                                <v-tooltip v-if="balance.tooltipText" bottom>
                                    ...
                                    <span>{{ balance.tooltipText }} {{ isTrx ? $t('common.trx') : $t('common.eth') }}</span>
                                </v-tooltip>
                            </v-card-title>
                            <v-card-title v-else>
                                <v-progress-linear
                    ...
                    <v-flex xs12 md6>
                        <v-card class="warning white--text pl-2 pr-2 desktop-block" flat>
                            <v-card-text class="pb-0">{{ isTrx ? $t('token.number.trx') : $t('token.number.eth') }}</v-card-text>
...
export default class AddressDetail extends Mixins(NumberFormatMixin, NetworkMixin) {
    /*
    ===================================================================================
      Props
    ===================================================================================
