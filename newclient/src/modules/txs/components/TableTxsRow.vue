    ...
    <v-layout>
                ...
                <v-layout grid-list-xs row wrap align-center justify-start fill-height class="pt-3 pb-3 pr-3 pl-3">
                    ...
                    <v-flex shrink pa-1>
                        <p class="black--text align-center">
                            ...
                            {{ isTrx ? $t('common.trx') : $t(`common.${transaction.value.unit}`) }}
                            <app-tooltip
                                v-if="transaction.value.tooltipText"
                                :text="`${transaction.value.tooltipText} ${isTrx ? $t('common.trx') : $t('common.eth')}`"
                            />
                        </p>
                    </v-flex>
                </v-layout>
      ...
      -->
        <v-flex hidden-sm-and-down sm12>
          ...
          =====================================================================================
          -->
                <v-flex v-if="!isTrx" hidden-md-and-down lg2>
