            ...
            <v-flex hidden-sm-and-down>
                <v-card flat white>
                    <v-layout grid-list-xs row wrap align-center justify-start fill-height class="row-desktop">
                        ...
                        <v-flex md2 pl-3>
                            <p v-if="balance">
                                {{ balance.value }}<span class="info--text pl-1">{{ isTrx ? $t(`common.trx`) : $t(`common.${balance.unit}`) }}</span>
                            </p>
...
export default class FavAddrTableRow extends Mixins(NumberFormatMixin, NetworkMixin) {
    /*
    ===================================================================================
      Props
    ===================================================================================
